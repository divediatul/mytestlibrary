...
import { getDefaultConfig, loadAdScript } from './config.js';
...
function Player({
  ...
  const CHANNEL_NAME= {
    '1xsyys39ko': 'Times Now',
    '1xsitrr9kk': 'Times Now Navbharat',
    '1xrcvfb9ol': 'ET Now',
    '1x88csv9oz': 'Mirror Now',
    '1x8fbim9o6': 'ET Now Swadesh',
  };
  const LIVE_CHANNEL_ID= '1xsyys39ko';
      ...
      {videoData &&
        ...
        (state.isSdkLoaded ? (
          ...
          >
            ...
            <img
              src={`https://static.tnn.in/thumb/resizemode-4,msid-${msid},width-360/${msid}.jpg`}
              alt=""
              className="mb-5"
              style={{
                width: '100%',
